...
contains(DEFINES,QTFIREBASE_BUILD_REMOTE_CONFIG) {
    ...
    ios: {
        LIBS += \
            -F$$QTFIREBASE_FRAMEWORKS_ROOT/FirebaseRemoteConfig/FirebaseRemoteConfig.xcframework/$$QTFIREBASE_FRAMEWORKS_PLATFORM \
            -F$$QTFIREBASE_FRAMEWORKS_ROOT/FirebaseRemoteConfig/FirebaseABTesting.xcframework/$$QTFIREBASE_FRAMEWORKS_PLATFORM \
...
contains(DEFINES,QTFIREBASE_BUILD_MESSAGING) {
    ...
    ios: {
        ...
        LIBS += \
            -F$$QTFIREBASE_FRAMEWORKS_ROOT/FirebaseMessaging/FirebaseMessaging.xcframework/$$QTFIREBASE_FRAMEWORKS_PLATFORM \
            -F$$QTFIREBASE_FRAMEWORKS_ROOT/FirebaseMessaging/Protobuf.xcframework/$$QTFIREBASE_FRAMEWORKS_PLATFORM \
            -F$$QTFIREBASE_FRAMEWORKS_ROOT/FirebaseMessaging/FirebaseInstanceID.xcframework/$$QTFIREBASE_FRAMEWORKS_PLATFORM \
...
contains(DEFINES,QTFIREBASE_BUILD_ANALYTICS) {
    ...
    ios: {
        ...
        LIBS += \
            ...
            -F$$QTFIREBASE_FRAMEWORKS_ROOT/FirebaseAnalytics/FirebaseCore.xcframework/$$QTFIREBASE_FRAMEWORKS_PLATFORM \
            -F$$QTFIREBASE_FRAMEWORKS_ROOT/FirebaseAnalytics/GoogleUtilities.xcframework/$$QTFIREBASE_FRAMEWORKS_PLATFORM \
            -F$$QTFIREBASE_FRAMEWORKS_ROOT/FirebaseAnalytics/nanopb.xcframework/$$QTFIREBASE_FRAMEWORKS_PLATFORM \
            -F$$QTFIREBASE_FRAMEWORKS_ROOT/FirebaseAnalytics/PromisesObjC.xcframework/$$QTFIREBASE_FRAMEWORKS_PLATFORM \
            -F$$QTFIREBASE_FRAMEWORKS_ROOT/FirebaseAnalytics/FirebaseInstallations.xcframework/$$QTFIREBASE_FRAMEWORKS_PLATFORM \
...
contains(DEFINES,QTFIREBASE_BUILD_AUTH) {
    ...
    ios: {
        LIBS += \            
            -F$$QTFIREBASE_FRAMEWORKS_ROOT/FirebaseAuth/FirebaseAuth.xcframework/$$QTFIREBASE_FRAMEWORKS_PLATFORM \
            -F$$QTFIREBASE_FRAMEWORKS_ROOT/FirebaseAuth/GTMSessionFetcher.xcframework/$$QTFIREBASE_FRAMEWORKS_PLATFORM \
...
contains(DEFINES,QTFIREBASE_BUILD_DATABASE) {
    ...
    ios: {
        LIBS += \
            -licucore \            
            -F$$QTFIREBASE_FRAMEWORKS_ROOT/FirebaseDatabase/FirebaseDatabase.xcframework/$$QTFIREBASE_FRAMEWORKS_PLATFORM \
            -F$$QTFIREBASE_FRAMEWORKS_ROOT/FirebaseDatabase/leveldb-library.xcframework/$$QTFIREBASE_FRAMEWORKS_PLATFORM \
